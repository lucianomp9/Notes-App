...
CREATE TABLE `note` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKhmtqn561muh2r322gpkajjilp` (`category_id`),
  CONSTRAINT `FKhmtqn561muh2r322gpkajjilp` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`)
...
-- Dump completed on 2024-02-01  0:04:13
